...
if __name__ == "__main__":
    ...
    dir_yaml_infer_high = os.path.join(
        os.environ.get("YAML_PATH_ANALYSIS"), "robustness_rotation_speed_low_train_high_infer_vb06_resnet.yaml")
    dir_yaml_infer_low = os.path.join(
        os.environ.get("YAML_PATH_ANALYSIS"), "robustness_rotation_speed_high_train_low_infer_vb06_resnet.yaml")
    ...
    dir_yaml_infer_mid = os.path.join(
        os.environ.get("YAML_PATH_ANALYSIS"), "robustness_rotation_speed_low_and_high_train_mid_infer_vb06_resnet.yaml")
    ...
    dir_yaml_infer_mid_pretrained = os.path.join(
        os.environ.get("YAML_PATH_ANALYSIS"), "robustness_rotation_speed_low_and_high_train_mid_infer_vb06_resnet_pretrained.yaml")
